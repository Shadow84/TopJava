...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    public void testUpdate() throws Exception {
        ...
        MATCHER.assertEquals(updated, userMealService.get(MEAL1_ID, START_SEQ));
    }
    ...
    public void testCreate() throws Exception {
        ...
        MATCHER.assertCollectionEquals(Arrays.asList(expected, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1), userMealService.getAll(START_SEQ));
    }
