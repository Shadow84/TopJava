...
public class UserMealsUtil {
    ...
    public static void main(String[] args) {
        ...
        List<UserMealWithExceed> filteredMealsWithExceeded = getFilteredWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIESPERDAY);
        filteredMealsWithExceeded.forEach(System.out::println);


        System.out.println(getFilteredWithExceededByCycle(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIESPERDAY));
    }
    ...
    public static UserMealWithExceed createWithExceed(UserMeal um, boolean exceeded) {
        return new UserMealWithExceed(MealIdGenerator.generate(), um.getDateTime(), um.getDescription(), um.getCalories(), exceeded);
    }
}